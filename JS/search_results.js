...
.then(function(data) {
    ...
    if (result.length > 0) {
        let contenido = ''
        for (let i = 0; i < 5; i++) {
            contenido += `<article class="cajahija"><a href="../JERO/detail-movie.html" class="letter">
                        <img class="imagen" src='https://image.tmdb.org/t/p/w500/${result[i].poster_path}' alt="" class="fotoscars">
