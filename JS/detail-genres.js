...
let urlUser_movie = `https://api.themoviedb.org/3/discover/movie?api_key=cf7707fd77a1290e2423ba7e39e253a8&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=${genre}&with_watch_monetization_types=flatrate`
let urlUser_series = `https://api.themoviedb.org/3/discover/tv?api_key=cf7707fd77a1290e2423ba7e39e253a8&language=en-US&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&with_genres=${genre}&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`
